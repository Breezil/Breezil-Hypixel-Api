...
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| Client and config  | [Client &amp; Config](/api/client)                                                                                                                                                                                                                  | Constructor forms, endpoint groups, `ping`/`request`/`hasApiKey`/`clearCache`, cache/rate-limit/retry pipeline behavior |
